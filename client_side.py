...
def response_check(answer): #prevents the need to add this code to every option
    if 'operation_message' in answer and answer['operation_message']['operation_code'] ==  0x2e:
        ...
        print(f"An unexpected response occured: {answer['operation_message']['operation_code']}")
    else:
    ...
    while True:
        ...
        while connection_lost == False:
            try:
                ...
                # print(f"{tmp_answer}") #for testing the responses
            ...
            if option == 0:
                ...
                try:
                    ...
                    while is_close_message != True:
                        answer = timeout_check()
                        if 'message' in answer and answer['message']['header']['operation_message'] == 0x13:
                            print(f"\t{answer['message']['data']}")
                        elif answer['operation_message']['operation_code'] == 0x27:
                ...
                try:
                    ...
                    while is_close_message != True:
                        answer = timeout_check()
                        if 'message' in answer and answer['message']['header']['operation_code'] == 0x14:
                            print(f"\t{answer['message']['data']}")
                        elif answer['operation_message']['operation_code'] == 0x29:
                            is_close_message = True
                        else:
                            is_close_message = True
                            response_check(answer)
